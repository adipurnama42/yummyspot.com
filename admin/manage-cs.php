...
<aside class="sidebar dash-sidebar">
    ...
    <a href="dashboard.php"  class="sb-item"><i class="fa-solid fa-gauge si"></i> Dashboard</a>
    <a href="dashboard.php?tab=users" class="sb-item"><i class="fa-solid fa-users si"></i> Kelola User</a>
