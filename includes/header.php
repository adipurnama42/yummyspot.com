...
<body>
  ...
  <div class="sidebar-drawer" id="sidebar-drawer">
    ...
    <?php elseif ($isCS): ?>
      <!-- ── CS DRAWER ─────────────────────── -->
      <a href="<?= APP_URL ?>/cs/dashboard.php?tab=catalogs" class="sb-item" onclick="closeDrawer()"><i class="fa-solid fa-building-store si"></i> Semua Katalog</a>
    ...
    <?php elseif ($isOwner): ?>
      ...
      <a href="<?= APP_URL ?>/owner/catalogs.php" class="sb-item" onclick="closeDrawer()"><i class="fa-solid fa-building-store si"></i> Katalog Saya</a>
