    ...
    <?php else: ?>
      <form method="POST" onsubmit="return confirm('Reset semua data? Tidak bisa dibatalkan!')">
        ...
        <table>
          ...
          <tbody>
            <tr>
              <td>superadmin@yummyspot.com</td>
              <td><code style="display:inline;padding:.1rem .4rem;background:#f0f0f0;border-radius:4px;">password123</code></td>
              <td>Admin</td>
            </tr>
            <tr>
              <td>cs@yummyspot.com</td>
              <td><code style="display:inline;padding:.1rem .4rem;background:#f0f0f0;border-radius:4px;">password123</code></td>
              <td>CS</td>
            </tr>
          </tbody>
